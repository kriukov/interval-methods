...
clean = IntervalBox(Interval(-0.4, 0.6), Interval(0.3, 0.8))
unclean1 = IntervalBox(Interval(-1.2, 0.6), Interval(0.3, 0.8))
unclean2 = IntervalBox(Interval(0.6, 1.2), Interval(0.3, 0.8))
unclean3 = IntervalBox(Interval(0.6, 0.8), Interval(-1.2, -0.7))
unclean4 = IntervalBox(Interval(0.6, 0.8), Interval(0.8, 1.2))
unclean5 = IntervalBox(Interval(-1.2, -0.5), Interval(0.8, 1.2))
dirty1 = IntervalBox(Interval(-1.5, -1.2), Interval(-1.5, -1.2))
dirty2 = IntervalBox(Interval(-1.5, -1.2), Interval(1.2, 1.5))
dirty3 = IntervalBox(Interval(1.2, 1.5), Interval(-1.5, -1.2))
dirty4 = IntervalBox(Interval(1.2, 1.5), Interval(1.2, 1.5))
...
clean1 = IntervalBox(Interval(-0.4, 0.4), Interval(-0.4, 0.4))
clean2 = IntervalBox(Interval(-1, -0.6), Interval(-0.7, -0.4))
unclean1 = IntervalBox(Interval(-1, 0), Interval(-1.2, -0.8))
unclean2 = IntervalBox(Interval(0, 1), Interval(-0.4, 0.3))
dirty1 = IntervalBox(Interval(0, 1), Interval(-1.6, -1.4))
dirty2 = IntervalBox(Interval(1.2, 2), Interval(1.2, 2.1))
...
clean = IntervalBox(Interval(-0.5, 0.5), Interval(-0.5, 0.5))
unclean = IntervalBox(Interval(0, 2), Interval(0, 2))
dirty = IntervalBox(Interval(1.5, 2), Interval(-2, -1.5))
